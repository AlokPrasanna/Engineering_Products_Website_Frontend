  ...
  return (
    <div className='relative flex flex-col w-full'>
      ...
      <section className='w-full'>
        ...
        >
          <h1 className='text-5xl font-semibold'>Contact Flexcept</h1>
      ...
      <section className='flex flex-col items-center justify-center w-full py-10'>
        <div className='w-[80%] flex flex-col md:flex-row gap-5'>
          <div className='w-full md:w-1/2'>
            <h2 className='py-5 text-xl font-bold'>Local Contact or Reseller</h2>
            <div className='px-5'>
              ...
              <p className='mb-2'><span className='font-bold'>Hours:</span> 7 AM to 5 PM MT<br />
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Monday to Friday</p>
              <p className='mb-2'><span className='font-bold'>Address:</span> 1900 Garden of the Gods Road<br />
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Colorado Springs, CO 80907-3423<br />
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; United States
              </p>
          ...
          <div className='w-full md:w-1/2'>
            ...
            <div className='px-5'>
              ...
              <button className='px-4 py-2 text-white transition-colors duration-300 bg-red-600 rounded hover:bg-red-500'>Continue</button>
            </div>
          </div>
        </div>
      </section>
