      ...
      <div className='flex flex-col items-center justify-center w-full'>
        ...
        >
            <div className='flex flex-col items-center justify-center'>
                ...
                <button className='w-full px-5 py-2 mt-5 mb-5 transition-colors duration-300 border-2 border-red-600 text-slate-50 hover:bg-red-600'><Link to={url}>Read the Case Study</Link></button>
                <h3 className='text-lg text-center text-slate-50'>{name}</h3>
                <h5 className='text-center text-slate-50 text-md'>{position}</h5>
            </div>
        </div>
      </div>  
    </div>
